...
License:        ASL 2.0
URL:            https://abseil.io
Source0:        https://github.com/abseil/abseil-cpp/archive/%{version}/abseil-cpp-%{version}.tar.gz
...
#
# Fixes RHBZ#2108658.
#Patch2:          https://github.com/abseil/abseil-cpp/commit/09e96049995584c3489e4bd1467313e3e85af99c.patch
...
Enhances: abseil-cpp-devel

%description devel
Development headers for %{name}

%prep
%autosetup -p1 -S gendiff -n abseil-cpp-%{version}
